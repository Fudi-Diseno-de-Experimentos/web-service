...
public record CreateMessageResource(
        @Schema(description = "DEPRECATED — ignored. The sender is always derived from the JWT to prevent impersonation.", example = "123e4567-e89b-12d3-a456-426614174000", requiredMode = Schema.RequiredMode.NOT_REQUIRED, deprecated = true)
        UUID senderId,
