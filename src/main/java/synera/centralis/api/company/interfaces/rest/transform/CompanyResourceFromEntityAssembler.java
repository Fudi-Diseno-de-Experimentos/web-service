...
public class CompanyResourceFromEntityAssembler {
    public static CompanyResource toResourceFromEntity(Company entity) {
        return new CompanyResource(entity.getId(), entity.getRuc(), entity.getNombre(), entity.getIconUrl(), entity.isActive(), entity.getUserId() != null ? entity.getUserId().userId() : null, entity.getJoinCode());
    }
}
